...
parser.add_argument('--letter', type = str, default = 'B', help = 'Letter identifying the instance set')
                                    ...
                                    for u in U:
                                        for b in B:
                                            ...
                                            if counter >= 0:
                                                ...
                                                keyword = '{}-{}-{}-{}-{}-{}-{}-{}-{}-{}-{}'.format(args.letter, s, i, j, str(t).zfill(2), c, r, a, o, u, b)
