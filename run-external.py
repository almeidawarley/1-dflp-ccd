...
def main():
    ...
    parser = ap.ArgumentParser(description = 'Run external Benders for some DSFLP-C instance')
    ...
    cm.mark_section('External subproblems, separating integer solutions only')
