...
class coverage(ic.instance):

    def __init__(self, keyword):

        super().__init__(keyword)

    def create_instance(self, folder = 'instances/coverage'):
                    ...
                    for location in self.locations:
                        ...
                        for customer in self.captured_customers[location]:
                            if period2 != self.final:
                                ...
                                self.coefficients[period1][period2][location][customer] = -1 * sum(self.spawning[period3][customer] for period3 in self.periods if period3 > period1 and period3 < period2)